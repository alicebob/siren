...
var _user$project$Pane$Entry = F4(
	function (a, b, c, d) {
		return {id: a, title: b, onClick: c, selection: d};
	});
var _user$project$Pane$Pane = F5(
	function (a, b, c, d, e) {
		return {id: a, title: b, body: c, current: d, update: e};
	});
var _user$project$Pane$Entries = function (a) {
	return {ctor: 'Entries', _0: a};
};
var _user$project$Pane$newPane = F3(
...
var _user$project$Pane$Plain = function (a) {
...
var _user$project$Main$cmdFindAdd = F3(
...
var _user$project$Main$cmdSeek = F2(
	function (id, seconds) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'cmd',
						_1: _elm_lang$core$Json_Encode$string('seek')
					},
					_1: {
						ctor: '::',
						_0: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'seconds',
								_1: _elm_lang$core$Json_Encode$float(seconds)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _user$project$Main$cmdPlaylistAdd = function (id) {
	return A2(_user$project$Main$buildWsCmdID, 'add', id);
};
var _user$project$Main$cmdClear = _user$project$Main$buildWsCmd('clear');
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {wsURL: a, status: b, statusT: c, playlist: d, view: e, fileView: f, artistView: g, now: h, seek: i, conn: j};
									};
								};
							};
						};
...
var _user$project$Main$Wait = function (a) {
	return {ctor: 'Wait', _0: a};
};
var _user$project$Main$Drag = function (a) {
...
var _user$project$Main$StartDrag = function (a) {
	return {ctor: 'StartDrag', _0: a};
};
var _user$project$Main$Seek = F2(
	function (a, b) {
		return {ctor: 'Seek', _0: a, _1: b};
	});
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: {
			...
			now: 0,
			seek: _user$project$Main$Display,
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										...
										seek: function () {
											var _p16 = model.seek;
											if (_p16.ctor === 'Wait') {
												return _user$project$Main$Display;
											} else {
												return model.seek;
											}
										}(),
						...
						case 'WSTrack':
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										fileView: A3(_user$project$Main$setTrackPane, _p17, _p18, model.fileView),
										artistView: A3(_user$project$Main$setTrackPane, _p17, _p18, model.artistView)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						default:
			...
			case 'AddFilePane':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							fileView: A3(_user$project$Pane$addPane, model.fileView, _p13._0, _p19)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
			...
			case 'AddArtistPane':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							artistView: A3(_user$project$Pane$addPane, model.artistView, _p13._0, _p20)
						}),
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$wsSend, model.conn, _p20.update),
								_1: {ctor: '[]'}
							}
						})
				};
				...
				if (_p21.ctor === 'Drag') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								seek: _user$project$Main$Wait(_p22)
							}),
						_1: A2(
							_user$project$Main$wsSend,
							model.conn,
							A2(_user$project$Main$cmdSeek, _p13._0, _p22))
					};
				} else {
					return {
						ctor: '_Tuple2',
			...
			case 'StartDrag':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							seek: _user$project$Main$Drag(_p13._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Noop':
...
var _user$project$Main$viewHeader = function (model) {
	...
	var titleClick = _p23._0;
	var titleTitle = _p23._1;
	var titleHover = _p23._2;
	var tab = F2(
		function (what, t) {
			return A2(
	...
	var count = A2(
		...
		A2(
			...
			_elm_lang$core$Basics$toString(
				_elm_lang$core$List$length(model.playlist)),
			')'));
	return A2(
		_elm_lang$html$Html$div,
		{
...
var _user$project$Main$pressPlay = _user$project$Main$SendWS(_user$project$Main$cmdPlay);
var _user$project$Main$pressStop = _user$project$Main$SendWS(_user$project$Main$cmdStop);
var _user$project$Main$pressPause = _user$project$Main$SendWS(_user$project$Main$cmdPause);
var _user$project$Main$pressClear = _user$project$Main$SendWS(_user$project$Main$cmdClear);
	...
	return A2(
		...
		function () {
			...
			if (_p25.ctor === 'Nothing') {
				...
				var realElapsed = _p29.elapsed + function () {
					var _p27 = _p29.state;
					if (_p27 === 'play') {
				...
				var prettyTime = A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'/',
						_user$project$Main$prettySecs(_p29.duration)));
				var slider = A2(
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$max(
										_elm_lang$core$Basics$toString(_p29.duration)),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html_Events$on,
											'input',
											A2(_elm_lang$core$Json_Decode$map, _user$project$Main$StartDrag, targetValueAsNumber)),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html_Events$on,
												...
												A2(
													_elm_lang$core$Json_Decode$map,
													_user$project$Main$Seek(_p29.songid),
													targetValueAsNumber)),
											_1: {ctor: '[]'}
										}
									}
							...
							switch (_p28.ctor) {
								...
								default:
									return {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											_elm_lang$core$Basics$toString(realElapsed)),
										_1: {ctor: '[]'}
									};
							}
						}()),
					{ctor: '[]'});
				var song = A2(_user$project$Mpd$lookupPlaylist, model.playlist, _p29.songid);
				return A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
					...
					(_elm_lang$core$Native_Utils.eq(_p29.state, 'pause') || _elm_lang$core$Native_Utils.eq(_p29.state, 'play')) ? {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
					...
					function (e) {
						...
						var current = function () {
							...
							if (_p30.ctor === 'Nothing') {
								...
								return _elm_lang$core$Native_Utils.eq(_p30._0.songid, e.id);
							}
						}();
...
var _user$project$Main$replaceAndPlay = function (v) {
	return _user$project$Main$SendWS(
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Main$cmdClear,
			A2(_elm_lang$core$Basics_ops['++'], v, _user$project$Main$cmdPlay)));
};
...
var _user$project$Main$viewPane = function (p) {
			...
			A2(
				...
				_elm_lang$core$Basics$identity,
				{
					...
					_0: _elm_lang$core$Native_Utils.eq(
						p.current,
						_elm_lang$core$Maybe$Just(e.id)) ? _elm_lang$core$Maybe$Just(
						_elm_lang$html$Html_Attributes$class('exp')) : _elm_lang$core$Maybe$Nothing,
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Maybe$map, _elm_lang$html$Html_Events$onClick, e.onClick),
						_1: {
							ctor: '::',
							_0: function () {
								var _p32 = e.selection;
								if (_p32.ctor === 'Nothing') {
									return _elm_lang$core$Maybe$Nothing;
								} else {
									return _elm_lang$core$Maybe$Just(
										_elm_lang$html$Html_Events$onDoubleClick(
											_user$project$Main$doubleClick(_p32._0)));
								}
							}(),
							_1: {ctor: '[]'}
						}
	...
	var viewBody = function (b) {
		var _p33 = b;
		if (_p33.ctor === 'Plain') {
			return _elm_lang$core$List$singleton(_p33._0);
		} else {
			return A2(_elm_lang$core$List$map, viewEntry, _p33._0);
		}
	};
	return {
		ctor: '::',
							...
							return {
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Main$SendWS(_p35)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Main$replaceAndPlay(_p35)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
